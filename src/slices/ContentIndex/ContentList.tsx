...
export default function ContentList({
  ...
  useEffect(() => {
    // Animate list-items in with a stagger - on page load
    ...
    }, component); // gsap component for context
  }, []);
  ...
  return (
    <>
      ...
      >
        {/* for demo ----- */}
        {/* {[...items, ...items, ...items, ...items, ...items, ...items].map((post, index) => ( */}
            ...
            {isFilled.keyText(post.data.title) && (
              ...
              >
                <Link
                  ...
                  // instead of {post.data.title || ""} => added {isFilled.keyText(item.data.title) => To make it more clean
                >
